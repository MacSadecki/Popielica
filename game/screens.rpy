...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Graj") action Start()
        ...
        textbutton _("Autorzy") action ShowMenu("about")
...
screen about():
    ...
    ## screen.
    use game_menu(_("Autorzy"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Wykonane przy użyciu {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
    ...
    use game_menu(_("Opcje"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Pomijanie tekstu")
                    textbutton _("Nowy tekst") action Preference("skip", "toggle")
            ...
            hbox:
                ...
                vbox:
                    ...
                    if config.has_sound:
                        ...
                        label _("Głośność efektów dzwiękowych")
...
screen history():
    ...
    use game_menu(_("Historia"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
        ...
        if not _history_list:
            label _("Historia dialogów jest pusta")
    ...
    use game_menu(_("Pomoc"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                ...
                if GamepadExists():
                    textbutton _("Pad") action SetScreenVariable("device", "gamepad")
...
screen keyboard_help():
    ...
    #hbox:
    #    label _("Enter")
    #    text _("Przecho dialogi i wybory")

    hbox:
        label _("Spacja")
        text _("Przechodzi do nastepnego dialogu")

    hbox:
        label _("Strzałki")
        text _("Nawigacja po interfejsie")
    ...
    hbox:
        label _("Ctrl")
        text _("Pomija dialogi gdy przytrzymane")
    ...
    hbox:
        label _("Page Up")
        text _("Cofa do poprzedniego dialogu")

    hbox:
        label _("Page Down")
        text _("Przechodzi do następnego dialogu")

    hbox:
        label "H"
        text _("Chowa interfejs")

    hbox:
        label "S"
        text _("Tworzy zrzut ekranu")
...
screen mouse_help():
    ...
    hbox:
        label _("Lewy Przycisk Myszki")
        text _("Przechodzi do nastepnego dialogu oraz aktywuje interfejs")

    hbox:
        label _("Środkowy Przycisk Myszki")
        text _("Chowa interfejs")

    hbox:
        label _("Prawy Przycisk Myszki")
        text _("Menu gry")

    hbox:
        label _("Scroll W Górę")
        text _("Cofa do poprzedniego dialogu")
